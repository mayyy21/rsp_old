...
##########################################################################
        ...
        #        ans1=i
        #print('ans1: ',ans1)
        #print('loud time: ',t_vec[ans1])
        #ti=len(t_vec)/10
        ax.set_xlabel('Time [s]') # x-axis in time
        ax.set_ylabel('Amplitude') # y-axis amplitude
        ax.legend(loc='upper left')
        ax.annotate(r'$amplitude: $'+' = {0:2.1f}'.format(loud),
                     xy=(t_vec[loud],data[loud]),
                     xytext=(t_vec[loud]/22050,
                             (data[loud]/22050)),
                     arrowprops=dict(facecolor='black',shrink=0.1)) # loud label

###################################################################################
#        ax.annotate(r'$f_{max}$'+' = {0:2.1f}Hz'.format(loud),
#                     xy=(loud,loud),
#                     xytext=(loud,
#                             loud),
...
#            if fft_data[i]==max_indx:
#                ans=i
#                break
#        print('ans: ',ans)
       
####
#        print('ffffffffffffff: ',t_vec[fft_data[max_indx]])
#        print('t_vec len: ',len(t_vec))
#        tii=max_indx*10
#        print('tttttttt: ',t_vec[tii])
#        print('idx: ',max_indx)
#        print('fft_data len: ',len(fft_data))
#        print('freq_vec len: ',len(freq_vec))
    ...
    if plt_2:
        ...
        print('fft_array len: ',len(fft_array))
...
########################################################################
    #print('len: ',len(freq_vec))

#    print('data: ',data_array[3])
